  ...
  return (
    <>
      ...
      <PageWrapper>
        <Card>
          {/* Filters & Search */}
          <div className="p-4 border-b border-border-subtle flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center bg-bg-surface/50">
            <div className="flex-1 w-full sm:w-auto relative flex items-center gap-3">
              ...
              <div className="flex border border-border-subtle rounded-md overflow-hidden bg-bg-surface">
                {['All', 'structured', 'chat'].map((type) => (
                  <button
                    key={type}
