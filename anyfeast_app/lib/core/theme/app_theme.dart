...
class AppTheme {
  ...
  static const Color brandPrimary =
      Color(0xFF0EA5E9); // Adjust to your actual primary green/blue
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      textTheme: GoogleFonts.interTextTheme().copyWith(
        displayLarge:
            GoogleFonts.dmSans(color: textPrimary, fontWeight: FontWeight.bold),
        displayMedium:
            GoogleFonts.dmSans(color: textPrimary, fontWeight: FontWeight.bold),
        titleLarge:
            GoogleFonts.dmSans(color: textPrimary, fontWeight: FontWeight.w600),
        titleMedium:
            GoogleFonts.dmSans(color: textPrimary, fontWeight: FontWeight.w600),
